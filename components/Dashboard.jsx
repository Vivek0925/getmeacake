     ...
     <>
      ...
      <div className='container mx-auto py-3 px-6 '>
          ...
          <form className="max-w-2xl mx-auto" action={handleSubmit}>
              ...
              <div className="my-2">
                  <label htmlFor="profilepic" className="block mb-2 text-sm font-medium text-gray-900 ">Profile Picture</label>
              ...
              {/* input for cover pic  */}
              <div className="my-2">
                  <label htmlFor="coverpic" className="block mb-2 text-sm font-medium text-gray-900 ">Cover Picture</label>
